...
// lifted from https://userswp.io/wordpress-profile-picture/
...
// Adding the Custom Image section for avatar.
		...
		<tr>
			...
			<td>
				...
				<span class="description">
					<?php _e('Upload a custom avatar for your profile, to remove the avatar simply delete the URL and click update.', 'ayecode'); ?>
				</span>
			</td>
		</tr>
	</table>
...
function ayecode_get_avatar_url( $url, $id_or_email, $args ) {
	...
	if( $custom_url == '' || !empty($args['force_default'])) {
		return esc_url_raw( 'https://2.gravatar.com/avatar/ebd104c7441e314107f9952d1f156123?s=96&d=mm&r=g' ); 
	}else{
